...
public class AddShould
{
	...
	public void Successfully_AddsNode_WhenListTypeIsOfString_AndListIsEmpty(String keyToBeAdded)
	{
		//Arrange
		var linkedList = new DoublyCircularLinkedList<String>();

		//Act
		linkedList.Add(keyToBeAdded);
	...
	[InlineData(10)]
	[InlineData(0)]
	public void Successfully_AddsNode_WhenListTypeIsOfInt32_AndListIsEmpty(Int32 keyToBeAdded)
	{
		//Arrange
		var linkedList = new DoublyCircularLinkedList<Int32>();
	...
	public void Successfully_AddsNode_WhenListTypeIsOfString_AndListHasOneOrMoreItems(
		String csStrings,
		String keyToBeAdded,
		Int32 expectedCount,
	...
	public void Successfully_AddsNode_WhenListTypeIsOfInt32_AndListHasOneOrMoreItems(
		String csStrings,
		Int32 keyToBeAdded,
		Int32 expectedCount,
		Boolean expectedIsEmpty,
