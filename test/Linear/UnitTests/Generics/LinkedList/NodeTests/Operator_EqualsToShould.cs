namespace Dsa.Linear.UnitTests.Generics.LinkedList.NodeTests;
public class Operator_EqualsToShould
{
	[Fact]
	...
	[Fact]
	public void ReturnFalse_WhenTypeIsInt32_AndRightNodeIsNotNull_ButLeftNodeIsNull()
	{
		//Arrange
	...
	[Fact]
	public void ReturnTrue_WhenTypeIsInt32_AndBothNodesAreNull()
	{
		//Arrange
	...
	[Fact]
	public void ReturnTrue_WhenTypeIsString_AndBothNodesAreNull()
	{
		//Arrange
